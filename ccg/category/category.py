...
class ChallengeCategory:
    ...
    If you want to create a custom category, just add it to `../models/category.py`, inherit this class and override the `generating()` method with your own code, adjust the difficulties if needed
    """
